...
const CLICHE_RULES: TransformRule[] = [
  ...
  { pattern: /\bresonates deeply with\b/gi, replacement: "connects strongly with", reason: "Replaced AI cliché." },
  { pattern: /\bcaptivating audiences\b/gi, replacement: "drawing audiences", reason: "Replaced promotional participle." },
