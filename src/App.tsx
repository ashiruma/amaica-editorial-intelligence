      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/style-guide" element={<Navigate to="/newsroom/editorial-policy" replace />} />
            ...
            <Route path="/newsroom/style-guide" element={<Navigate to="/newsroom/editorial-policy" replace />} />
